...
| 内容 | Overview + Shadow vs BH + 1H sparkline + 提案/记忆/事件/净值 + System |

System 细视图与完整 K 线组件（含 TradingView 归因）仍可后续追加；当前已覆盖 Gate 1/2 只读面：提案回放、影子对比、K 线 sparkline、Memories、Events。

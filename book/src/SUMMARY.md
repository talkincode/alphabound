...
- [Docker 与 GHCR](guide/docker.md)
- [故障排查](guide/troubleshooting.md)

# 概念

- [四支柱架构](concepts/pillars.md)
- [风险模型](concepts/risk.md)
- [Agent、工具与记忆](concepts/agent-memory.md)
- [事件与审计](concepts/events.md)

# 开发

- [构建与测试](dev/build.md)
- [代码结构](dev/structure.md)
- [关键不变量](dev/invariants.md)
